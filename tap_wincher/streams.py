...
def date_parser(input_date: str) -> str:
   ...
   # table_name: str = "wincher"+input_date.split(",")[0]+input_date.split(",")[1]
...
STREAMS: MappingProxyType = MappingProxyType({
    "wincher": {
        ...
        'mapping': {
            'start_date':{
                'map': 'start_date','null': False,
            },
            'refunds': { 
                'map': 'refunds', 'null': False,
            },
            'commissions': {
                'map': 'commissions', 'nullgit ': False,
            },
            'summary_per_currency': {
                'map': 'summary_per_currency', 'null': False,
            },
        }
    },
})